...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Workflows", to: "/noc/workflows", icon: GitMerge, section: "Network Operations", adminOnly: true },
  { label: "Polaris Revenue", to: "/revenue", icon: DollarSign, section: "Revenue Management", adminOnly: true },
